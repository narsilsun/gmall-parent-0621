...
public class SpuInfo extends BaseEntity {
	...
	@ApiModelProperty(value = "商品名称")//华为 HUAWEI Mate 30 5G 麒麟990 400
	@TableField("spu_name")
	private String spuName;

	@ApiModelProperty(value = "商品描述(后台简述）")//商品名称：华为Mate 30 5G商品编号
	@TableField("description")
	private String description;

	@ApiModelProperty(value = "三级分类id")//61
	@TableField("category3_id")
	private Long category3Id;

	@ApiModelProperty(value = "品牌id")//2
	@TableField("tm_id")
	private Long tmId;
